...
public:
	...
	static constexpr int SKILL_POS_X = ICON_SIZE + SKILL_SIZE_X + SKILL_ICON_SIZE_X / 2 + 10;//ICON_SIZE + SKILL_SIZE_X / 2 - 10;
	...
	void Init(PlayerBase& player,const DataBank::PLAYER_INFO& info);
	void Load()override;
